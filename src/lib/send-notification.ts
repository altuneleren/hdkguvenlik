...
interface NotificationPayload {
  title: string;
  message: string;
  url?: string; // Tıklandığında açılacak sayfa (ör: "https://hdkguvenlik.com/admin")
...
const ONESIGNAL_REST_API_KEY = process.env.ONESIGNAL_REST_API_KEY || "os_v2_app_z5uoklsqr5cjldqijxmkdyk3wlyfybplc5ouvg4s5kwzygsthcsoazbkgvtxwdecfssl2ocgojzy6ein6lvnsyrhjvy6zu2mfc3xnoq";
